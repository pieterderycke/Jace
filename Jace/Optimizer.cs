...
namespace Jace
{
    public class Optimizer
    {
        ...
        public Operation Optimize(Operation operation, IFunctionRegistry functionRegistry)
        {
            ...
            {
                double result = this.executor.Execute(operation, functionRegistry);
            ...
            {
                Function func = (Function)operation;
                var optArgs = func.Arguments.Select(a => Optimize(a, functionRegistry));
                func.Arguments = optArgs.ToList();
            }
