...
namespace Jace.Execution
{
    public interface IFunctionRegistry
    {
        ...
        void RegisterFunction(string functionName, Delegate function, int numberOfParameters);
        void RegisterFunction(string functionName, Delegate function, int numberOfParameters, bool isOverWritable);
    }
}
